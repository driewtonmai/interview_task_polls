...
urlpatterns = [
    ...
    path('polls/<int:polls_pk>/questions/', views.QuestionListCreateAPIView.as_view(), name='questions-list-create'),
    path('polls/<int:polls_pk>/questions/<int:questions_pk>/',
         views.QuestionDetailAPIView.as_view(), name='questions-retrieve'),
]
